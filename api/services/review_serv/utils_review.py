...
from api.services.review_serv import listar_reviews_by_site
...
def create_review(site_id, review_data, user_id):
    ...
    from api.services.review_serv import create_review_service
...
def get_review_by_id(review_id, site_id, include_pending=False):
    ...
    from api.services.review_serv import get_review_by_id_service
...
def delete_review(review_id, site_id):
    ...
    from api.services.review_serv import delete_review_service
